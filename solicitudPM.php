...
<div class="row">
	<div class="small-6 columns">
	    <p align="left">
          ...
          <input name="mailsol2" type="text" id="mailsol2"   placeholder="Email">
       </p>
   </div>
	 <div class="small-6 columns">
	   <p align="left">
	      <input name="colsol" type="text" id="colsol"   placeholder="Colonia">
          <input name="cdsol" type="text" id="cdsol"   placeholder="Ciudad">
          <input name="edosol" type="text" id="edosol"    placeholder="Estado">
          <input name="cpsol" type="text" id="cpsol"    placeholder="C.P.">
	    </p>
</div>
  </div>
...
<div class="row">
      <p align="left">RFC con homoclave:
        ...
        <div class="small-1 columns">  <input name="rfcconemp1" type="text" id="rfcconemp1"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp2)"></div>
        <div class="small-1 columns">  <input name="rfcconemp2" type="text" id="rfcconemp2"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp3)"></div>
        <div class="small-1 columns">  <input name="rfcconemp3" type="text" id="rfcconemp3"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp4)"></div>
        <div class="small-1 columns">  <input name="rfcconemp4" type="text" id="rfcconemp4"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp5)"></div>
        <div class="small-1 columns">  <input name="rfcconemp5" type="text" id="rfcconemp5"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp6)"></div>
        <div class="small-1 columns">  <input name="rfcconemp6" type="text" id="rfcconemp6"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp7)"></div>
        <div class="small-1 columns">  <input name="rfcconemp7" type="text" id="rfcconemp7"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp8)"></div>
        <div class="small-1 columns">  <input name="rfcconemp8" type="text" id="rfcconemp8"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp9)"></div>
        <div class="small-1 columns">  <input name="rfcconemp9" type="text" id="rfcconemp9"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp10)"></div>
        <div class="small-1 columns">  <input name="rfcconemp10" type="text" id="rfcconemp10"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp11)"></div>
        <div class="small-1 columns">  <input name="rfcconemp11" type="text" id="rfcconemp11"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp12)"></div>
        <div class="small-1 columns">  <input name="rfcconemp12" type="text" id="rfcconemp12"  maxlength="1" onKeyUp="myFunction(this,this.value,rfcconemp13)"></div></div>
        <div class="small-1 columns">  <input name="rfcconemp13" type="text" id="rfcconemp13"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp1)"></div>
      </p>
</div>
<div class="row">
      <p align="left">Telefono partiular (Con lada - 10 dígitos) : 
        <div class="small-1 columns">  <input name="telconemp1" type="text" id="telconemp1"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp2)"></div>
        <div class="small-1 columns">  <input name="telconemp2" type="text" id="telconemp2"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp3)"></div>
        <div class="small-1 columns">  <input name="telconemp3" type="text" id="telconemp3"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp4)"></div>
        <div class="small-1 columns">  <input name="telconemp4" type="text" id="telconemp4"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp5)"></div>
        <div class="small-1 columns">  <input name="telconemp5" type="text" id="telconemp5"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp6)"></div>
        <div class="small-1 columns">  <input name="telconemp6" type="text" id="telconemp6"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp7)"></div>
        <div class="small-1 columns">  <input name="telconemp7" type="text" id="telconemp7"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp8)"></div>
        <div class="small-1 columns">  <input name="telconemp8" type="text" id="telconemp8"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp9)"></div>
        <div class="small-1 columns">  <input name="telconemp9" type="text" id="telconemp9"  maxlength="1" onKeyUp="myFunction(this,this.value,telconemp10)"></div>
        <div class="small-1 columns">  <input name="telconemp10" type="text" id="telconemp10"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp1)"></div>
        </p>
</div>

<div class="row">
      <p align="left">Fax (Con Lada) : 
        <div class="small-1 columns">  <input name="faxconemp1" type="text" id="faxconemp1"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp2)"></div>
        <div class="small-1 columns">  <input name="faxconemp2" type="text" id="faxconemp2"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp3)"></div>
        <div class="small-1 columns">  <input name="faxconemp3" type="text" id="faxconemp3"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp4)"></div>
        <div class="small-1 columns">  <input name="faxconemp4" type="text" id="faxconemp4"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp5)"></div>
        <div class="small-1 columns">  <input name="faxconemp5" type="text" id="faxconemp5"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp6)"></div>
        <div class="small-1 columns">  <input name="faxconemp6" type="text" id="faxconemp6"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp7)"></div>
        <div class="small-1 columns">  <input name="faxconemp7" type="text" id="faxconemp7"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp8)"></div>
        <div class="small-1 columns">  <input name="faxconemp8" type="text" id="faxconemp8"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp9)"></div>
        <div class="small-1 columns">  <input name="faxconemp9" type="text" id="faxconemp9"  maxlength="1" onKeyUp="myFunction(this,this.value,faxconemp10)"></div>
        <div class="small-1 columns">  <input name="faxconemp10" type="text" id="faxconemp10"  maxlength="1" onKeyUp="myFunction(this,this.value,mailconemp)"></div>
      </p>
</div>
<div class="row">
      <p align="left">
  <div class="small-5 columns">  
        <input name="mailconemp" type="text" id="mailconemp"  placeholder="Email">
        </div>
     <div class="small-5 columns">  
        <input name="puesconemp" type="text" id="puesconemp"  placeholder="Puesto que desempeña en la empresa">
    </div>
      </p>
      ...
      <div class="row">
        <p align="left">
        <div class="small-5 columns">  
              <input name="actprinc" type="text" id="actprinc"  placeholder="Actividad Principal/según alta o último cambio ante SHCP">
          </div>
          <div class="small-5 columns">  
              <input name="cantperson" type="text" id="cantperson"  placeholder="Cantidad de personal">
          </div>
          </p>
      </div>
...
<div class="row">
      <p align="left">Fecha inicio de operaciones:
          <div class="small-2 columns"><input name="inicoper1" type="text" id="inicoper1"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,inicoper2)"></div>
       </p>
</div>
      <hr>
      ...
      <p align="left">
          Fecha de contitución de la empresa:
           <div class="small-2 columns"><input name="inicoper13" type="text" id="inicoper13"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,inicoper23)"></div>
        </p>
      </div>
      <div class="row">
          <p align="left">
             <div class="small-5 columns"><input name="antemp" type="text" id="antemp"  placeholder="Antigüedad"></div>
             <div class="small-7 columns"><input name="apodsusc" type="text" id="apodsusc"  placeholder="Apoderado para suscribir Títulos de Crédito y realizar actos de administración"></div>
          </p>
      </div>
      <hr>
      ...
      <div class="row">
      <p align="left">
          <div class="small-4 columns"><input name="refbanc" type="text" id="refbanc"  placeholder="Banco"></div>
          <div class="small-4 columns"><input name="numcuebanc" type="text" id="numcuebanc"  placeholder="Número de cuenta"></div>
          <div class="small-4 columns"><input name="sucbanc1" type="text" id="sucbanc1"  placeholder="Sucursal"></div>
        </p>
      </div>
...
<div class="row">
      <p align="left">
        ...
        Fecha de apertura:
  <div class="small-2 columns"><input name="aperbanc1d" type="text" id="aperbanc1d"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,aperbanc1m)"></div>
   </p>
</div>
<hr>
     <div class="row">
      <p align="left">
          <div class="small-4 columns"><input name="refbanc2" type="text" id="refbanc2"  placeholder="Banco"></div>
          <div class="small-4 columns"><input name="tarjrefbanc" type="text" id="tarjrefbanc"  placeholder="Número de Tarjeta de Crédito"></div>
          <div class="small-4 columns"><input name="sucbanc2" type="text" id="sucbanc2"  placeholder="Sucursal"></div>
        </p>
     </div>
<div>
      <p align="left">
        Fecha de apertura:
  <div class="small-2 columns"><input name="aperbanc1d2" type="text" id="aperbanc1d2"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,aperbanc1m2)"></div>
   </p>
</div>
      <hr>
      ...
      <div class="row">
      <p align="left">
          <div class="small-5 columns"><input name="cargdir" type="text" id="cargdir"  placeholder="Banco"></div>
          <div class="small-5 columns"><input name="nocuentcd" type="text" id="nocuentcd"  placeholder="Número de Cuenta (CLAVE)"></div>
      </p>
      </div>
      <hr>
      ...
      <p align="left">
       ...
       <p align="left">  Telefono(Con lada - 10 dígitos):
          <div class="small-1 columns"><input name="telrefcom11" type="text" id="telrefcom11"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom12)"></div>
          <div class="small-1 columns"><input name="telrefcom12" type="text" id="telrefcom12"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom13)"></div>
          <div class="small-1 columns"><input name="telrefcom13" type="text" id="telrefcom13"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom14)"></div>
          <div class="small-1 columns"><input name="telrefcom14" type="text" id="telrefcom14"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom15)"></div>
          <div class="small-1 columns"><input name="telrefcom15" type="text" id="telrefcom15"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom16)"></div>
          <div class="small-1 columns"><input name="telrefcom16" type="text" id="telrefcom16"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom17)"></div>
          <div class="small-1 columns"><input name="telrefcom17" type="text" id="telrefcom17"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom18)"></div>
          <div class="small-1 columns"><input name="telrefcom18" type="text" id="telrefcom18"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom19)"></div>
          <div class="small-1 columns"><input name="telrefcom19" type="text" id="telrefcom19"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom110)"></div>
          <div class="small-1 columns"><input name="telrefcom110" type="text" id="telrefcom110"  maxlength="1" onKeyUp="myFunction(this,this.value,antirefcom1)"></div>
         </p>
        </div>
     <div class="row">
      <p align="left">
       <div class="small-5 columns"> <input name="antirefcom1" type="text" id="antirefcom1" placeholder="Antigüedad Desde del Año"></div>
       <div class="small-5 columns"> <input name="refcomemp2" type="text" id="refcomemp2"  placeholder="Empresa"></div>
      </p>
     </div>
     
        <div class="row">
 <p align="left">Telefono(Con lada - 10 dígitos):
<div class="small-1 columns"><input name="telrefcom21" type="text" id="telrefcom21"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom22)"></div>
<div class="small-1 columns"><input name="telrefcom22" type="text" id="telrefcom22"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom23)"></div>
<div class="small-1 columns"><input name="telrefcom23" type="text" id="telrefcom23"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom24)"></div>
<div class="small-1 columns"><input name="telrefcom24" type="text" id="telrefcom24"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom25)"></div>
<div class="small-1 columns"><input name="telrefcom25" type="text" id="telrefcom25"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom26)"></div>
<div class="small-1 columns"><input name="telrefcom26" type="text" id="telrefcom26"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom27)"></div>
<div class="small-1 columns"><input name="telrefcom27" type="text" id="telrefcom27"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom28)"></div>
<div class="small-1 columns"><input name="telrefcom28" type="text" id="telrefcom28"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom29)"></div>
<div class="small-1 columns"><input name="telrefcom29" type="text" id="telrefcom29"  maxlength="1" onKeyUp="myFunction(this,this.value,telrefcom210)"></div>
<div class="small-1 columns"><input name="telrefcom210" type="text" id="telrefcom210"  maxlength="1" onKeyUp="myFunction(this,this.value,antirefcom2)"> </div>
    </p>
        </div>

      <p align="left">
          <div class="small-5 columns"><input name="antirefcom2" type="text" id="antirefcom2" placeholder="Antigüedad Desde del Año"></div>
        </p>
    <hr>
      <p align="left"><strong>DATOS DEL OBLIGADO SOLIDARIO PERSONA MORAL</strong></p>
      <div class="row"> 
      <p align="left">
          <div class="small-4 columns"><input name="nomrazsoc" type="text" id="nomrazsoc"  placeholder="Nombre, Razón Social"></div>
        </p>
      </div>

      <div class="row">
      <p align="left">Telefono(Con lada - 10 dígitos):
  <div class="small-1 columns"><input name="telpermor1" type="text" id="telpermor1"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor2)"></div>
  <div class="small-1 columns"><input name="telpermor2" type="text" id="telpermor2"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor3)"></div>
  <div class="small-1 columns"><input name="telpermor3" type="text" id="telpermor3"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor4)"></div>
  <div class="small-1 columns"><input name="telpermor4" type="text" id="telpermor4"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor5)"></div>
  <div class="small-1 columns"><input name="telpermor5" type="text" id="telpermor5"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor6)"></div>
  <div class="small-1 columns"><input name="telpermor6" type="text" id="telpermor6"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor7)"></div>
  <div class="small-1 columns"><input name="telpermor7" type="text" id="telpermor7"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor8)"></div>
  <div class="small-1 columns"><input name="telpermor8" type="text" id="telpermor8"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor9)"></div>
  <div class="small-1 columns"><input name="telpermor9" type="text" id="telpermor9"  maxlength="1" onKeyUp="myFunction(this,this.value,telpermor10)"></div>
  <div class="small-1 columns"><input name="telpermor10" type="text" id="telpermor10"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc1)"></div>
      </p>
      </div>
      <div class="row">
      ...
      <p align="left">RFC con homoclave:
        <div class="small-10 columns">
        <div class="small-1 columns"><input name="permorrfc1" type="text" id="permorrfc1"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc2)"></div>
        <div class="small-1 columns"><input name="permorrfc2" type="text" id="permorrfc2"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc3)"></div>
        <div class="small-1 columns"><input name="permorrfc3" type="text" id="permorrfc3"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc4)"></div>
        <div class="small-1 columns"><input name="permorrfc4" type="text" id="permorrfc4"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc5)"></div>
        <div class="small-1 columns"><input name="permorrfc5" type="text" id="permorrfc5"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc6)"></div>
        <div class="small-1 columns"><input name="permorrfc6" type="text" id="permorrfc6"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc7)"></div>
        <div class="small-1 columns"><input name="permorrfc7" type="text" id="permorrfc7"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc8)"></div>
        <div class="small-1 columns"><input name="permorrfc8" type="text" id="permorrfc8"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc9)"></div>
        <div class="small-1 columns"><input name="permorrfc9" type="text" id="permorrfc9"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc10)"></div>
        <div class="small-1 columns"><input name="permorrfc10" type="text" id="permorrfc10"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc11)"></div>
        <div class="small-1 columns"><input name="permorrfc11" type="text" id="permorrfc11"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc12)"></div>
        <div class="small-1 columns"><input name="permorrfc12" type="text" id="permorrfc12"  maxlength="1" onKeyUp="myFunction(this,this.value,permorrfc13)"></div></div>
        <div class="small-1 columns"><input name="permorrfc13" type="text" id="permorrfc13"  maxlength="1" onKeyUp="myFunction(this,this.value,dirpermor)"></div>
        </p>
      </div>
      <div class="row">
      <p align="left">
         <div class="small-6 columns"> <input name="dirpermor" type="text" id="dirpermor"  placeholder="Dirección / Calle y número"></div>
       </p>
       </div>
       <div>
    <p align="left">    Fax(Con lada - 10 dígitos):
  <div class="small-1 columns"><input name="faxpermor1" type="text" id="faxpermor1"  maxlength="1" onKeyUp="myFunction(this,this.value,faxpermor2)"></div>
  <div class="small-1 columns"><input name="faxpermor2" type="text" id="faxpermor2"  maxlength="1"onKeyUp="myFunction(this,this.value,faxpermor3)" ></div>
  <div class="small-1 columns"><input name="faxpermor3" type="text" id="faxpermor3"  maxlength="1" onKeyUp="myFunction(this,this.value,faxpermor4)"></div>
  <div class="small-1 columns"><input name="faxpermor4" type="text" id="faxpermor4"  maxlength="1" onKeyUp="myFunction(this,this.value,faxpermor5)"></div>
  <div class="small-1 columns"><input name="faxpermor5" type="text" id="faxpermor5"  maxlength="1" onKeyUp="myFunction(this,this.value,faxpermor6)"></div>
  <div class="small-1 columns"><input name="faxpermor6" type="text" id="faxpermor6"  maxlength="1" onKeyUp="myFunction(this,this.value,faxpermor7)"></div>
  <div class="small-1 columns"><input name="faxpermor7" type="text" id="faxpermor7"  maxlength="1" onKeyUp="myFunction(this,this.value,faxpermor8)"></div>
  <div class="small-1 columns"><input name="faxpermor8" type="text" id="faxpermor8"  maxlength="1" onKeyUp="myFunction(this,this.value,faxpermor9)"></div>
  <div class="small-1 columns"><input name="faxpermor9" type="text" id="faxpermor9"  maxlength="1" onKeyUp="myFunction(this,this.value,faxpermor10)"></div>
  <div class="small-1 columns"><input name="faxpermor10" type="text" id="faxpermor10"  maxlength="1" onKeyUp="myFunction(this,this.value,colpermor)"></div>
        </p>
      </div>
<div>
      <p align="left">  
          <div class="small-3 columns"><input name="colpermor" type="text" id="colpermor"  placeholder="Colonia"></div>
          <div class="small-3 columns"><input name="cdpermor" type="text" id="cdpermor"  placeholder="Ciudad"></div>
          <div class="small-3 columns"><input name="edopermor" type="text" id="edopermor"  placeholder="Estado"></div>
          <div class="small-3 columns"><input name="cppremor" type="text" id="cppremor"  placeholder="C.P."></div>
        </p>
</div>
      <hr>
      <p align="left"><strong>CONSTITUCIÓN DE LA EMPRESA</strong></p>
      <div class="row">
      <p align="left">
          <div class="small-5 columns"><input name="antemp2" type="text" id="antemp2"  placeholder="Antigüedad"></div>
          <div class="small-5 columns"><input name="apodsusc2" type="text" id="apodsusc2"  placeholder="Apoderado para suscribir Títulos de Crédito y realizar actos de administración"></div>
      </p>
      </div>
      <hr>
      ...
      <div class="row">
      <p align="left">
          <div class="small-5 columns"><input name="actprinc2" type="text" id="actprinc2"  placeholder="Actividad Principal/según alta o último cambio ante SHCP"></div>
          <div class="small-5 columns"><input name="cantperson2" type="text" id="cantperson2"  placeholder="Cantidad de personal"></div>
        </p>
      </div>
      <div class="row">
      <p align="left">Fecha inicio de operaciones:
        <div class="small-4 columns"><input name="inicoper12" type="date" id="inicoper12"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,inicoper22)"></div>
          </p>
      </div>
      <hr>
</div>
      ...
      <div class="row">
        <div class="small-6 columns">
      <p align="left">
        <input name="accionista1" type="text" id="accionista1"  placeholder="Nombre">
        <input name="rfcaccion1" type="text" id="rfcaccion1"  placeholder="RFC">
        <input name="%1" type="text" id="%1"  placeholder="%">
        </p>
      <p align="left">
        <input name="accionista2" type="text" id="accionista2"  placeholder="Nombre">
          <input name="rfcaccion2" type="text" id="rfcaccion2"  placeholder="RFC">
          <input name="%2" type="text" id="%2"  placeholder="%">
</p>
      <p align="left">
        <input name="accionista3" type="text" id="accionista3"  placeholder="Nombre">
          <input name="rfcaccion3" type="text" id="rfcaccion3"  placeholder="RFC">
          <input name="%3" type="text" id="%3"  placeholder="%">
</p>
      <p align="left">
        <input name="accionista4" type="text" id="accionista4"  placeholder="Nombre">
          <input name="rfcaccion4" type="text" id="rfcaccion4"  placeholder="RFC">
          <input name="%4" type="text" id="%4"  placeholder="%">
</p>
</div>
      </div>
      ...
      <div class="row">
        <div class="small-6 columns">
      <p align="left">
        <input name="accpermor1" type="text" id="accpermor1"  placeholder="Nombre">
          <input name="rfcaccpermor1" type="text" id="rfcaccpermor1"  placeholder="RFC">
          <input name="%permoracc1" type="text" id="%permoracc1"  placeholder="%">
</p>
      <p align="left">
        <input name="accpermor2" type="text" id="accpermor2"  placeholder="Nombre">
          <input name="rfcaccpermor2" type="text" id="rfcaccpermor2"  placeholder="RFC">
          <input name="%permoracc2" type="text" id="%permoracc2"  placeholder="%">
</p>
      </div>
  </div>
      </div>
      ...
      <div class="row">
        <div class="small-5 columns">
      <p align="left">
        <input name="datobnom1" type="text" id="datobnom1"  placeholder="Nombre(s)">
          <input name="datobappat1" type="text" id="datobappat1"  placeholder="Apellido Paterno">
          <input name="datobapmat1" type="text" id="datobapmat1"  placeholder="Apellido Materno">
      </p>
  </div>
      </div>
      <div>
      ...
      <p align="left">
        <div class="small-6 columns">
        <input name="datobdir1" type="text" id="datobdir1"  placeholder="Dirección / Calle y número">
        <input name="datobcol1" type="text" id="datobcol1"  placeholder="Colonia">
      </div>
      <div class="small-6 columns">
        <input name="datobcd1" type="text" id="datobcd1"  placeholder="Ciudad">
        <input name="datoblugnac1" type="text" id="datoblugnac1"  placeholder="Lugar nacimiento (País y Edo.)">
    </div>
      Tiene propiedad a su nombre? 
      <input id="prop1" name="datobprop1" required type="radio" value="1"> <label for="prop1">Si</label>
     
      <input id="prop2" name="datobprop1" required type="radio" value="2"><label for="prop2">No</label>
</p>
  ...
  <div class="row">
    <div class="small-6 columns">
      <p align="left">
        <input name="datobedo1" type="text" id="datobedo1"  placeholder="Estado">
          <input name="datobcp1" type="text" id="datobcp1"  placeholder="C.P.">
          <input  name="datobmail1" type="text" id="datobmail1"  placeholder="Email">
      </p>
  </div>
  </div>
      <p align="left">
      sexo:
        ...
        <input id="se1"  name="datobsex1" required type="radio" value="M">  <label for="se1"><i class="step fi-male size-72"></i> M</label> 
      
        <input id="se2" name="datobsex1" required type="radio" value="F">   <label for="se2"><i class="fi-female size-36"></i>F</label>
    </p>
<div class="row">
<p align="left">
Fecha de nacimiento:
<div class="small-2 columns"><input name="datobfechnac1d" type="date" id="datobfechnac1d"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,datobfechnac1m)"></div>
      </p>
      </div>
      <div class="row">
      <p align="left">
      <div class="small-6 columns"><input name="datobed1" type="text" id="datobed1"  placeholder="Edad"></div>
    <div class="small-6 columns"><input name="datobcurp1" type="text" id="datobcurp1"  placeholder="CURP"></div>
      </p>
      </div>
<div class="row">
      <p align="left">RFC con homoclave:
        <div class="small-10 columns">
          <div class="small-1 columns"><input name="datobrfc11" type="text" id="datobrfc11"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc12)"></div>
          <div class="small-1 columns"><input name="datobrfc12" type="text" id="datobrfc12"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc13)"></div>
          <div class="small-1 columns"><input name="datobrfc13" type="text" id="datobrfc13"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc14)"></div>
          <div class="small-1 columns"><input name="datobrfc14" type="text" id="datobrfc14"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc15)"></div>
          <div class="small-1 columns"><input name="datobrfc15" type="text" id="datobrfc15"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc16)"></div>
          <div class="small-1 columns"><input name="datobrfc16" type="text" id="datobrfc16"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc17)"></div>
          <div class="small-1 columns"><input name="datobrfc17" type="text" id="datobrfc17"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc18)"></div>
          <div class="small-1 columns"><input name="datobrfc18" type="text" id="datobrfc18"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc19)"></div>
          <div class="small-1 columns"><input name="datobrfc19" type="text" id="datobrfc19"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc110)"></div>
          <div class="small-1 columns"><input name="datobrfc110" type="text" id="datobrfc110"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc111)"></div>
          <div class="small-1 columns"><input name="datobrfc111" type="text" id="datobrfc111"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc112)"></div>
          <div class="small-1 columns"><input name="datobrfc112" type="text" id="datobrfc112"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc113)"></div></div>
          <div class="small-1 columns"><input name="datobrfc113" type="text" id="datobrfc113"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel11)"></div>
        </p>
</div>

    <div class="row">
      <p align="left">Telefono(Con lada - 10 dígitos):
          <div class="small-1 columns"><input name="datobtel11" type="text" id="datobtel11"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel12)"></div>
          <div class="small-1 columns"><input name="datobtel12" type="text" id="datobtel12"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel13)"></div>
          <div class="small-1 columns"><input name="datobtel13" type="text" id="datobtel13"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel14)"></div>
          <div class="small-1 columns"><input name="datobtel14" type="text" id="datobtel14"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel15)"></div>
          <div class="small-1 columns"><input name="datobtel15" type="text" id="datobtel15"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel16)"></div>
          <div class="small-1 columns"><input name="datobtel16" type="text" id="datobtel16"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel17)"></div>
          <div class="small-1 columns"><input name="datobtel17" type="text" id="datobtel17"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel18)"></div>
          <div class="small-1 columns"><input name="datobtel18" type="text" id="datobtel18"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel19)"></div>
          <div class="small-1 columns"><input name="datobtel19" type="text" id="datobtel19"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel110)"></div>
          <div class="small-1 columns"><input name="datobtel110" type="text" id="datobtel110"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel112)"></div>
</p>
    </div>
      <div class="row">
      <p align="left">Telefono móvil(Con lada - 10 dígitos):
          <div class="small-1 columns"><input name="datobtel112" type="text" id="datobtel112"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel122)"></div>
          <div class="small-1 columns"><input name="datobtel122" type="text" id="datobtel122"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel132)"></div>
          <div class="small-1 columns"><input name="datobtel132" type="text" id="datobtel132"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel142)"></div>
          <div class="small-1 columns"><input name="datobtel142" type="text" id="datobtel142"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel152)"></div>
          <div class="small-1 columns"><input name="datobtel152" type="text" id="datobtel152"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel162)"></div>
          <div class="small-1 columns"><input name="datobtel162" type="text" id="datobtel162"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel172)"></div>
          <div class="small-1 columns"><input name="datobtel172" type="text" id="datobtel172"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel182)"></div>
          <div class="small-1 columns"><input name="datobtel182" type="text" id="datobtel182"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel192)"></div>
          <div class="small-1 columns"><input name="datobtel192" type="text" id="datobtel192"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1102)"></div>
          <div class="small-1 columns"><input name="datobtel1102" type="text" id="datobtel1102"  maxlength="1" onKeyUp="myFunction(this,this.value,obsol1)"></div>
</p>
      </div>
      <div class="row">
      <p align="left">
       <div class="small-7 columns"> <input name="obsol1" type="text" id="obsol1"  placeholder="Obligado Solidario (Nombre (s), apellido paterno, apellido materno )"></div>
    ...
    <div class="small-6 columns">
          sexo: 
            <input id="se3" name="datobsex11" required type="radio" value="M"> <label for="se3"><i class="step fi-male size-72"></i> M</label>


      <input id="se4" name="datobsex11" required type="radio" value="F">  <label for="se4"><i class="step fi-female size-72"></i> F</label>
    </div>
    </p>
    </div>
      <div class="row">
        <p align="left">
      Fecha de nacimiento:
      <div class="small-2 columns"><input name="datobfechnac1d2" type="date" id="datobfechnac1d2"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,datobfechnac1m2)"></div>
       </p>
      </div>

<div class="row">
      <p align="left">
        <div class="small-4 columns"><input name="datobnom22" type="text" id="datobnom22"  placeholder="R.F.C. con homoclave"></div>
          <div class="small-4 columns"><input name="datobappat22" type="text" id="datobappat22"  placeholder="CURP"></div>
          <div class="small-4 columns"><input name="datobapmat22" type="text" id="datobapmat22"  placeholder="Edad"></div>
</p>
</div>
      </div>
      <hr>
     ...
     <div class="row">
      <p align="left">
        <div class="small-4 columns"><input name="datobnom2" type="text" id="datobnom2"  placeholder="Nombre(s)"></div>
          <div class="small-4 columns"><input name="datobappat2" type="text" id="datobappat2"  placeholder="Apellido Paterno"></div>
          <div class="small-4 columns"><input name="datobapmat2" type="text" id="datobapmat2"  placeholder="Apellido Materno"></div>
</p>
      <p align="left">
          <div class="small-5 columns"><input name="datobdir2" type="text" id="datobdir2"  placeholder="Dirección / Calle y número"></div>
          <div class="small-5 columns"><input name="datobcol2" type="text" id="datobcol2"  placeholder="Colonia"></div>
          <div class="small-5 columns"><input name="datobcd2" type="text" id="datobcd2"  placeholder="Ciudad"></div>
          <div class="small-5 columns"><input name="datoblugnac2" type="text" id="datoblugnac2"  placeholder="Lugar nacimiento (País y Edo.)"></div>
        </p>
     </div>
      <p align="left">
        Tiene propiedad a su nombre? 
  <input id="pro1" name="datobprop2" required type="radio" value="Si"><label for="pro1">Si</label>
      
  <input id="pro2" name="datobprop2" required type="radio" value="No"><label for="pro2">  No</label>
        </p>

        <div class="row">
      <p align="left">
          <div class="small-6 columns"><input name="datobedo2" type="text" id="datobedo2"  placeholder="Estado"></div>
          <div class="small-6 columns"><input name="datobcp2" type="text" id="datobcp2"  placeholder="C.P."></div>
          <div class="small-6 columns"><input  name="datobmail2" type="text" id="datobmail2"  placeholder="Email"></div>
        </p>
        </div>
      <p align="left">sexo: 
        <input id="se5" required name="datobsex2" type="radio" value="M"><label for="se5"><i class="step fi-male size-72"></i> M</label>
       
  <input id="se6" required name="datobsex2" type="radio" value="F"><label for="se6"><i class="step fi-female size-72"></i> F</label>
</p>
<div class="row">
<p align="left">
        Fecha de nacimiento:
     <div class="small-2 columns"><input name="datobfechnac2d" type="text" id="datobfechnac2d"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,datobfechnac2m)"></div>
    
     <div class="small-6 columns"><input name="datobed2" type="text" id="datobed2"  placeholder="Edad"></div>
     <div class="small-6 columns"><input name="datobcurp2" type="text" id="datobcurp2"  placeholder="CURP"></div>
        </p>
</div>
      ...
      <p align="left">RFC con homoclave:
        <div class="small-10 columns">
         <div class="small-1 columns"><input name="datobrfc21" type="text" id="datobrfc21"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc22)"></div>
         <div class="small-1 columns"><input name="datobrfc22" type="text" id="datobrfc22"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc23)"></div>
         <div class="small-1 columns"><input name="datobrfc23" type="text" id="datobrfc23"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc24)"></div>
         <div class="small-1 columns"><input name="datobrfc24" type="text" id="datobrfc24"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc25)"></div>
         <div class="small-1 columns"><input name="datobrfc25" type="text" id="datobrfc25"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc26)"></div>
         <div class="small-1 columns"><input name="datobrfc26" type="text" id="datobrfc26"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc27)"></div>
         <div class="small-1 columns"><input name="datobrfc27" type="text" id="datobrfc27"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc28)"></div>
         <div class="small-1 columns"><input name="datobrfc28" type="text" id="datobrfc28"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc29)"></div>
         <div class="small-1 columns"><input name="datobrfc29" type="text" id="datobrfc29"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc210)"></div>
         <div class="small-1 columns"><input name="datobrfc210" type="text" id="datobrfc210"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc211)"></div>
         <div class="small-1 columns"><input name="datobrfc211" type="text" id="datobrfc211"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc212)"></div>
         <div class="small-1 columns"><input name="datobrfc212" type="text" id="datobrfc212"  maxlength="1" onKeyUp="myFunction(this,this.value,datobrfc213)"></div></div>
         <div class="small-1 columns"><input name="datobrfc213" type="text" id="datobrfc213"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel21)"></div>
        </p>
        </div>
        <div class="row">
      <p align="left">Telefono(Con lada - 10 dígitos):
        <div class="small-1 columns"><input name="datobtel21" type="text" id="datobtel21"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel22)"></div>
        <div class="small-1 columns"><input name="datobtel22" type="text" id="datobtel22"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel23)"></div>
        <div class="small-1 columns"><input name="datobtel23" type="text" id="datobtel23"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel24)"></div>
        <div class="small-1 columns"><input name="datobtel24" type="text" id="datobtel24"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel25)"></div>
        <div class="small-1 columns"><input name="datobtel25" type="text" id="datobtel25"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel26)"></div>
        <div class="small-1 columns"><input name="datobtel26" type="text" id="datobtel26"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel27)"></div>
        <div class="small-1 columns"><input name="datobtel27" type="text" id="datobtel27"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel28)"></div>
        <div class="small-1 columns"><input name="datobtel28" type="text" id="datobtel28"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel29)"></div>
        <div class="small-1 columns"><input name="datobtel29" type="text" id="datobtel29"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel210)"></div>
        <div class="small-1 columns"><input name="datobtel210" type="text" id="datobtel210"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1122)"></div>
        </p>
        </div>
        <div class="row">

      <p align="left">Telefono móvil(Con lada - 10 dígitos):
          <div class="small-1 columns"><input name="datobtel1122" type="text" id="datobtel1122"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1222)"></div>
          <div class="small-1 columns"><input name="datobtel1222" type="text" id="datobtel1222"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1322)"></div>
          <div class="small-1 columns"><input name="datobtel1322" type="text" id="datobtel1322"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1422)"></div>
          <div class="small-1 columns"><input name="datobtel1422" type="text" id="datobtel1422"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1522)"></div>
          <div class="small-1 columns"><input name="datobtel1522" type="text" id="datobtel1522"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1622)"></div>
          <div class="small-1 columns"><input name="datobtel1622" type="text" id="datobtel1622"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1722)"></div>
          <div class="small-1 columns"><input name="datobtel1722" type="text" id="datobtel1722"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1822)"></div>
          <div class="small-1 columns"><input name="datobtel1822" type="text" id="datobtel1822"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel1922)"></div>
          <div class="small-1 columns"><input name="datobtel1922" type="text" id="datobtel1922"  maxlength="1" onKeyUp="myFunction(this,this.value,datobtel11022)"></div>
          <div class="small-1 columns"><input name="datobtel11022" type="text" id="datobtel11022"  maxlength="1" onKeyUp="myFunction(this,this.value,obsol2)"></div>
</p>
        </div>
      <p align="left">
        <input name="obsol2" type="text" id="obsol2"  placeholder="Obligado Solidario (Nombre (s), apellido paterno, apellido materno )">
sexo: 
<input id="se7"  required name="datobsex22" type="radio" value="M"> <label for="se7"><i class="step fi-male size-72"></i>M</label>

<input id="se8" required name="datobsex22" type="radio" value="F"> <label for="se8"><i class="step fi-female size-72"></i>F</label>
</p>
<div class="row">
<p align="left">
Fecha de nacimiento:
<div class="small-2 columns"><input name="datobfechnac1d22" type="text" id="datobfechnac1d22"  maxlength="2" placeholder="dd" onKeyUp="myFunction(this,this.value,datobfechnac1m22)"></div>
</p>
</div>
<div class="row">
      <p align="left">
          <div class="small-4 columns"><input name="datobnom222" type="text" id="datobnom222"  placeholder="R.F.C. con homoclave"></div>
          <div class="small-4 columns"><input name="datobappat222" type="text" id="datobappat222"  placeholder="CURP"></div>
          <div class="small-4 columns"><input name="datobapmat222" type="text" id="datobapmat222"  placeholder="Edad"></div>
        </p>
</div>
      </div>
      <hr>
...
<div class="row">
 ...
 <div class="small-5 columns">
      ...
      <div class="row">
      <p align="left">
        <div class="small-4 columns"><input name="clavcon" type="text" id="clavcon"  placeholder="Clave Consesionario o Distribuidor"></div>
          <div class="small-4 columns"><input name="nomcons" type="text" id="nomcons"  placeholder="Nombre Concesionario o Distribuidor"></div>
          <div class="small-4 columns"><input name="fecha" type="text" id="fecha" value="<?php echo date("Y-m-d");?>"  readonly></div>
    </p>  
      </div>
      <div class="row">
      <p align="justify">
        <div class="small-4 columns"><input name="nomvend" type="text" id="nomvend"  placeholder="Nombre del Vendedor"></div>
          <div class="small-4 columns"><input name="gerentegral" type="text" id="gerentegral"  placeholder="Nombre y firma del Gerente General"></div>
</p>
      </div>
   ...
   <div id="fid">
          ...
          <table width="100%" border="0">
            ...
            <tr>
              ...
              <td><input name="textfield30" type="text" id="textfield30"  ></td>
            </tr>
            <tr>
              <td>Nacionalidad</td>
            ...
            <tr>
              ...
              <td><input name="textfield35" type="text" id="textfield35" ></td>
            </tr>
            <tr>
              <td>Puesto</td>
            ...
            <tr>
              ...
              <td><input name="textfield37" type="text" id="textfield37" ></td>
            </tr>
            <tr>
              <td>Ingresos Adicionales Mensuales Apox </td>
              <td><input name="textfield38" type="text" id="textfield38"  ></td>
            </tr>
          </table>
      <br>
          <hr>
      ...
      <br>
          ...
          <table width="100%" border="0">
            <tr>
              ...
              <td width="39%"><input name="textfield65" type="text" id="textfield65"   ></td>
              <td width="7%">Fuente</td>
              <td width="33%"><input name="textfield66" type="text" id="textfield66"   ></td>
            </tr>
            <tr>
              <td>Ingresos Comprobable(2) </td>
              <td><input name="textfield67" type="text" id="textfield67"   ></td>
              <td>Fuente</td>
              <td><input name="textfield68" type="text" id="textfield68"   ></td>
            </tr>
            <tr>
              <td>Ingresos Comprobable(3) </td>
              <td><input name="textfield69" type="text" id="textfield69"   ></td>
              <td>Fuente</td>
              <td><input name="textfield70" type="text" id="textfield70"  ></td>
            </tr>
            <tr>
              <td>Ingresos Comprobable(4) </td>
              <td><input name="textfield71" type="text" id="textfield71"   ></td>
              <td>Fuente</td>
              <td><input name="textfield72" type="text" id="textfield72"   ></td>
            </tr>
            <tr>
              <td>Ingresos Comprobable(5) </td>
              <td><input name="textfield73" type="text" id="textfield73"   ></td>
              <td>Fuente</td>
              <td><input name="textfield74" type="text" id="textfield74"   ></td>
            </tr>
            <tr>
              <td>Ingresos No Comprobable(1) </td>
              <td><input name="textfield75" type="text" id="textfield75"   ></td>
              <td>Fuente</td>
              <td><input name="textfield76" type="text" id="textfield76"   ></td>
            </tr>
            <tr>
              <td>Ingresos No Comprobable(2)</td>
              <td><input name="textfield77" type="text" id="textfield77"   ></td>
              <td>Fuente</td>
              <td><input name="textfield78" type="text" id="textfield78"   ></td>
            </tr>
            <tr>
              <td>Ingresos No Comprobable(3)</td>
              <td><input name="textfield79" type="text" id="textfield79"  ></td>
              <td>Fuente</td>
              <td><input name="textfield80" type="text" id="textfield80"   ></td>
            </tr>
            <tr>
              <td>Ingresos No Comprobable(4)</td>
              <td><input name="textfield81" type="text" id="textfield81"   ></td>
              <td>Fuente</td>
              <td><input name="textfield82" type="text" id="textfield82"   ></td>
            </tr>
            <tr>
              <td>Ingresos No Comprobable(5)</td>
              <td><input name="textfield83" type="text" id="textfield83"   ></td>
              <td>Fuente</td>
              <td><input name="textfield84" type="text" id="textfield84"   ></td>
            </tr>
          </table>
      <br>
          <table width="100%" border="0">
            <tr>
              ...
              <td width="81%"><input name="textfield85" type="text" id="textfield85"   ></td>
            </tr>
            <tr>
              <td>Valor del Automóvil </td>
              <td><input name="textfield86" type="text" id="textfield86"   ></td>
            </tr>
            <tr>
              <td>Enganche del Automóvil </td>
              <td><input name="textfield87" type="text" id="textfield87"   ></td>
            </tr>
            <tr>
              <td>Porcentaje de Enganche </td>
              <td><input name="textfield88" type="text" id="textfield88"  ></td>
            </tr>
            <tr>
              <td>Porcentaje de Financieamiento </td>
              <td><input name="textfield89" type="text" id="textfield89"  ></td>
            </tr>
            <tr>
              <td>Monto Financiado </td>
              <td><input name="textfield90" type="text" id="textfield90"   ></td>
            </tr>
            <tr>
              <td>Plazo (meses)</td>
              <td><input name="textfield91" type="text" id="textfield91"  ></td>
            </tr>
            <tr>
              <td>Pago Mensual Esperado </td>
              <td><input name="textfield92" type="text" id="textfield92"  ></td>
            </tr>
          </table>
...
<input name="PEPS" type="radio" value="2">
        ...
        <table width="100%" border="0">
            <tr>
              ...
              <td width="82%"><input name="textfield93" type="text" id="textfield93"  ></td>
            </tr>
            <tr>
              <td>Parentesco</td>
              <td><input name="textfield94" type="text" id="textfield94"  ></td>
            </tr>
            <tr>
              <td>Puesto</td>
              <td><input name="textfield95" type="text" id="textfield95"   ></td>
            </tr>
          </table>
        <p align="left">&nbsp; </p>
        <hr>
