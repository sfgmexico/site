...
<div class="row">
          <p align="left">RFC con homoclave:
            ...
            <div class="small-1 columns"><input name="rfc1" type="text" id="rfc1" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][0];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc2)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc2" type="text" id="rfc2" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][1];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc3)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc3" type="text" id="rfc3" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][2];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc4)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc4" type="text" id="rfc4" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][3];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc5)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc5" type="text" id="rfc5" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][4];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc6)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc6" type="text" id="rfc6" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][5];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc7)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc7" type="text" id="rfc7" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][6];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc8)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc8" type="text" id="rfc8" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][7];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc9)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc9" type="text" id="rfc9" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][8];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc10)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc10" type="text" id="rfc10" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][9];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc11)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc11" type="text" id="rfc11" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][10];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc12)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="rfc12" type="text" id="rfc12" size="1px" value="<?php if(isset($row2['Folio_Cliente']))  { echo $row2['RFCSolicitante'][11];}?>" maxlength="1" onKeyUp="myFunction(this,this.value,rfc13)" onkeypress="return validaRFC(event)" pattern="alpha_numeric"></div></div>
         ...
         <div class="row">
          <p align="left">Telefono partiular (Con lada - 10 dígitos) :
            <div class="small-1 columns"><input name="telsol1" type="text" id="telsol1" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][0]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol2)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol2" type="text" id="telsol2" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][1]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol3)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol3" type="text" id="telsol3" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][2]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol4)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol4" type="text" id="telsol4" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][3]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol5)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol5" type="text" id="telsol5" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][4]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol6)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol6" type="text" id="telsol6" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][5]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol7)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol7" type="text" id="telsol7" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][6]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol8)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol8" type="text" id="telsol8" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][7]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol9)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol9" type="text" id="telsol9" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][8]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,telsol10)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telsol10" type="text" id="telsol10" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['TelSolicitante'][9]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,movsol1)" onkeypress="return validaNumero(event)" pattern="integer"></div>
          </p>
         </div>
         <div class="row">
          <p align="left">Telefono movil (Con lada - 10 dígitos):
            <div class="small-1 columns"><input name="movsol1" type="text" id="movsol1" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['MovSolicitante'][0]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,movsol2)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="movsol2" type="text" id="movsol2" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['MovSolicitante'][1]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,movsol3)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="movsol3" type="text" id="movsol3" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['MovSolicitante'][2]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,movsol4)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="movsol4" type="text" id="movsol4" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['MovSolicitante'][3]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,movsol5)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="movsol5" type="text" id="movsol5" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['MovSolicitante'][4]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,movsol6)" onkeypress="return validaNumero(event)" pattern="integer"></div>
            <div class="small-1 columns"><input name="movsol6" type="text" id="movsol6" size="1px" value="<?php if(isset($row2['Folio_Cliente'])) { echo $row2['MovSolicitante'][5]; } ?>" maxlength="1" onKeyUp="myFunction(this,this.value,movsol7)" onkeypress="return validaNumero(event)" pattern="integer"></div>
         ...
         <div class="small-5 columns"> <input name="marcasol"value="<?php if(isset($row2['Folio_Cliente'])) {  echo $row2['MarDatGen']; } ?>"  type="text" id="marcasol" size="70px" placeholder="Especifique Marca y Tipo"></div>
          ...
          <div class="row">
          <p align="left">Telefono(Con lada - 10 dígitos):
            <div class="small-1 columns"><input name="telref11" type="text" id="telref11" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][0]; } ?>" maxlength="1"  onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref12)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref12" type="text" id="telref12" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][1]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref13)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref13" type="text" id="telref13" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][2]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref14)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref14" type="text" id="telref14" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][3]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref15)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref15" type="text" id="telref15" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][4]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref16)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref16" type="text" id="telref16" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][5]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref17)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref17" type="text" id="telref17" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][6]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref18)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref18" type="text" id="telref18" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][7]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref19)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref19" type="text" id="telref19" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][8]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref110)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref110" type="text" id="telref110" size="1px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer'][9]; } ?>" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,nomref2)" pattern="integer"></div>
          </p>
          </div>
          </div>
          ...
          <div class="row">
          <p align="left">Telefono(Con lada - 10 dígitos):
            <div class="small-1 columns"><input name="telref21" type="text" id="telref21" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][0]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref22)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref22" type="text" id="telref22" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][1]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref23)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref23" type="text" id="telref23" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][2]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref24)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref24" type="text" id="telref24" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][3]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref25)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref25" type="text" id="telref25" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][4]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref26)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref26" type="text" id="telref26" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][5]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref27)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref27" type="text" id="telref27" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][6]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref28)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref28" type="text" id="telref28" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][7]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref29)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref29" type="text" id="telref29" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][8]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,telref210)" pattern="integer"></div>
            <div class="small-1 columns"><input name="telref210" type="text" id="telref210" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelRefPer2'][9]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,refbanc)" pattern="integer"></div>
          </p>
          </div>
          </div>
          ...
          <p align="left">RFC con homoclave:
            ...
            <div class="small-1 columns"><input name="datobrfc11" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][0]; } ?>" type="text" id="datobrfc11" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc12)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc12" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][1]; } ?>" type="text" id="datobrfc12" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc13)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc13" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][2]; } ?>" type="text" id="datobrfc13" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc14)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc14" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][3]; } ?>" type="text" id="datobrfc14" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc15)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc15" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][4]; } ?>" type="text" id="datobrfc15" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc16)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc16" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][5]; } ?>" type="text" id="datobrfc16" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc17)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc17" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][6]; } ?>" type="text" id="datobrfc17" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc18)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc18" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][7]; } ?>" type="text" id="datobrfc18" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc19)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc19" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][8]; } ?>" type="text" id="datobrfc19" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc110)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc110" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][9]; } ?>" type="text" id="datobrfc110" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc111)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc111" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][10]; } ?>" type="text" id="datobrfc111" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc112)" pattern="alpha_numeric"></div>
            <div class="small-1 columns"><input name="datobrfc112" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][11]; } ?>" type="text" id="datobrfc112" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc113)" pattern="alpha_numeric"></div></div>
            <div class="small-1 columns"><input name="datobrfc113" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol'][12]; } ?>" type="text" id="datobrfc113" size="1px" maxlength="1" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobtel11)" pattern="alpha_numeric"></div>
          </p>
          </div>
          <div class="row">
          <p align="left">Telefono(Con lada - 10 dígitos):
            <div class="small-1 columns"><input name="datobtel11" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][0]; } ?>" type="text" id="datobtel11" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel12)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel12" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][1]; } ?>" type="text" id="datobtel12" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel13)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel13" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][2]; } ?>" type="text" id="datobtel13" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel14)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel14" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][3]; } ?>" type="text" id="datobtel14" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel15)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel15" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][4]; } ?>" type="text" id="datobtel15" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel16)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel16" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][5]; } ?>" type="text" id="datobtel16" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel17)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel17" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][6]; } ?>" type="text" id="datobtel17" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel18)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel18" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][7]; } ?>" type="text" id="datobtel18" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel19)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel19" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][8]; } ?>" type="text" id="datobtel19" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel110)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel110" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol'][9]; } ?>" type="text" id="datobtel110" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel112)" pattern="integer"></div>
          </p>
          </div>
          <p align="left">Telefono Movil (Con lada - 10 dígitos):
            <div class="small-1 columns"><input name="datobtel112" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][0]; } ?>" type="text" id="datobtel112" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel122)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel122" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][1]; } ?>" type="text" id="datobtel122" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel132)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel132" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][2]; } ?>" type="text" id="datobtel132" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel142)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel142" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][3]; } ?>" type="text" id="datobtel142" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel152)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel152" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][4]; } ?>" type="text" id="datobtel152" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel162)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel162" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][5]; } ?>" type="text" id="datobtel162" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel172)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel172" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][6]; } ?>" type="text" id="datobtel172" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel182)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel182" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][7]; } ?>" type="text" id="datobtel182" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel192)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel192" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][8]; } ?>" type="text" id="datobtel192" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel1102)" pattern="integer"></div>
            <div class="small-1 columns"><input name="datobtel1102" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol'][9]; } ?>" type="text" id="datobtel1102" size="1px" maxlength="1" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobnom2)" pattern="integer"></div>
          </p>
          </div>
          <hr>
         ...
         <div class="row">
          ...
          <p align="left">RFC con homoclave:
            <div class="small-10 columns">
            <div class="small-1 columns"><input name="datobrfc21" type="text" id="datobrfc21" size="1px" maxlength="1"  value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][0]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc22)"></div>
            <div class="small-1 columns"><input name="datobrfc22" type="text" id="datobrfc22" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][1]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc23)"></div>
            <div class="small-1 columns"><input name="datobrfc23" type="text" id="datobrfc23" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][2]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc24)"></div>
            <div class="small-1 columns"><input name="datobrfc24" type="text" id="datobrfc24" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][3]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc25)"></div>
            <div class="small-1 columns"><input name="datobrfc25" type="text" id="datobrfc25" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][4]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc26)"></div>
            <div class="small-1 columns"><input name="datobrfc26" type="text" id="datobrfc26" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][5]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc27)"></div>
            <div class="small-1 columns"><input name="datobrfc27" type="text" id="datobrfc27" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][6]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc28)"></div>
            <div class="small-1 columns"><input name="datobrfc28" type="text" id="datobrfc28" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][7]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc29)"></div>
            <div class="small-1 columns"><input name="datobrfc29" type="text" id="datobrfc29" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][8]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc210)"></div>
            <div class="small-1 columns"><input name="datobrfc210" type="text" id="datobrfc210" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][9]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc211)"></div>
            <div class="small-1 columns"><input name="datobrfc211" type="text" id="datobrfc211" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][10]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc212)"></div>
            <div class="small-1 columns"><input name="datobrfc212" type="text" id="datobrfc212" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][11]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobrfc213)"></div></div>
            <div class="small-1 columns"><input name="datobrfc213" type="text" id="datobrfc213" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['RFCObSol2'][12]; } ?>" onkeypress="return validaRFC(event)" onKeyUp="myFunction(this,this.value,datobtel21)"></div>
          </p>
            </div>
            <div class="row">
          <p align="left">Telefono(Con lada - 10 dígitos):
            <div class="small-1 columns"><input name="datobtel21" type="text" id="datobtel21" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][0]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel22)"></div>
            <div class="small-1 columns"><input name="datobtel22" type="text" id="datobtel22" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][1]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel23)"></div>
            <div class="small-1 columns"><input name="datobtel23" type="text" id="datobtel23" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][2]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel24)"></div>
            <div class="small-1 columns"><input name="datobtel24" type="text" id="datobtel24" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][3]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel25)"></div>
            <div class="small-1 columns"><input name="datobtel25" type="text" id="datobtel25" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][4]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel26)"></div>
            <div class="small-1 columns"><input name="datobtel26" type="text" id="datobtel26" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][5]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel27)"></div>
            <div class="small-1 columns"><input name="datobtel27" type="text" id="datobtel27" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][6]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel28)"></div>
            <div class="small-1 columns"><input name="datobtel28" type="text" id="datobtel28" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][7]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel29)"></div>
            <div class="small-1 columns"><input name="datobtel29" type="text" id="datobtel29" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][8]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel210)"></div>
            <div class="small-1 columns"><input name="datobtel210" type="text" id="datobtel210" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['TelObSol2'][9]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel212)"></div>
          </p>
            </div>
            <div class="row">
          <p align="left">Telefono Movil(Con lada - 10 dígitos):
            <div class="small-1 columns"><input name="datobtel212" type="text" id="datobtel212" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][0]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel222)"></div>
            <div class="small-1 columns"><input name="datobtel222" type="text" id="datobtel222" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][1]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel232)"></div>
            <div class="small-1 columns"><input name="datobtel232" type="text" id="datobtel232" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][2]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel242)"></div>
            <div class="small-1 columns"><input name="datobtel242" type="text" id="datobtel242" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][3]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel252)"></div>
            <div class="small-1 columns"><input name="datobtel252" type="text" id="datobtel252" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][4]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel262)"></div>
            <div class="small-1 columns"><input name="datobtel262" type="text" id="datobtel262" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][5]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel272)"></div>
            <div class="small-1 columns"><input name="datobtel272" type="text" id="datobtel272" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][6]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel282)"></div>
            <div class="small-1 columns"><input name="datobtel282" type="text" id="datobtel282" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][7]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel292)"></div>
            <div class="small-1 columns"><input name="datobtel292" type="text" id="datobtel292" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][8]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,datobtel2102)"></div>
            <div class="small-1 columns"><input name="datobtel2102" type="text" id="datobtel2102" size="1px" maxlength="1" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['MovObSol2'][9]; } ?>" onkeypress="return validaNumero(event)" onKeyUp="myFunction(this,this.value,clavcon)"></div>
          </p>
            </div>
            </div>
          <hr>
          <div class="row">
          <p align="justify">
            <div class="small-5 columns"><input name="clavcon" type="text" id="clavcon" size="30px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['ClavConcesionario']; } ?>" placeholder="Clave Consesionario o Distribuidor" required></div>
            <div class="small-5 columns"><input name="nomcons" type="text" id="nomcons" size="30px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['NomConcesionario']; } ?>" placeholder="Nombre Concesionario o Distribuidor" required></div>
            <div class="small-5 columns"><input name="nomvend" type="text" id="nomvend" size="48px" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['NomVendedor']; } ?>" placeholder="Nombre del Vendedor" required></div>
            <div class="small-5 columns"><input name="gerentegral" type="text" id="gerentegral" value="<?php if(isset($row['Folio_Cliente'])) {  echo $row['NomGerenteGral']; } ?>" size="48px" placeholder="Nombre y firma del Gerente General" required></div>
        ...
        <div id="identificacion">
          ...
          <table width="100%" border="0">
            <tr>
              ...
              <td width="29%" id="secINE"><input id="copiasA" name="copias" type="radio" value="1" <?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_INESolicitante']=='Si'){echo "checked";} } ?>><label for="copiasA"> Si</label>  <input id="copiasB" name="copias" type="radio" value="2" <?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_INESolicitante']=='No'){echo "checked";} } ?>><label for="copiasB"> No</label></td>
            </tr>
            <tr>
              ...
              <td id="secCedProfesional"><input id="copias2A" name="copias2" type="radio" value="1"<?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_Pasaporte_o_CedulaProfSolicitante']=='Si'){echo "checked";} } ?>><label for="copias2A"> Si</label>  <input id="copias2B" name="copias2" type="radio" value="2"<?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_Pasaporte_o_CedulaProfSolicitante']=='<noscript>
            ...
            <tr>
              ...
              <td>Se adjunta copia: </td>
              <td id="secLicConducir"><input id="copias4A" name="copias4" type="radio" value="1" <?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_LicenciaConducirSolicitante']=='Si'){echo "checked";} } ?>><label for="copias4A"> Si</label>
                                      <input id="copias4B" name="copias4" type="radio" value="2" <?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_LicenciaConducirSolicitante']=='No'){echo "checked";} } ?>><label for="copias4B"> No</label></td>
            </tr>
            <tr>
              <td>Otra</td>
              ...
              <td>Se adjunta copia: </td>
              <td id="secOtrIdentificacion"><input id="copias5A" name="copias5" type="radio" value="1" <?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_OtraIdentSolicitante']=='Si'){echo "checked";} } ?>><label for="copias5A"> Si</label>
                                            <input id="copias5B" name="copias5" type="radio" value="2" <?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_OtraIdentSolicitante']=='No'){echo "checked";} } ?>><label for="copias5B"> No</label></td>
            </tr>
            <tr>
              <td>Especificar</td>
              ...
              <td ><input id="cotejo1" name="cotejo" type="radio" value="1" <?php if(isset($row['Folio_Cliente'])) { if($row3['CotejoVsOriginal']=='Si'){echo "checked";} } ?> required><label for="cotejo1"> Si</label>
		  ...
		  <table width="100%" border="0">
            <tr>
              ...
              <td width="70%"><input id="adjuntos1A" name="adjuntos1" type="radio" value="1" <?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_CURP_RFC_FEA']=='Si'){echo "checked";} } ?> required><label for="adjuntos1A"> Si</label>
            ...
            <tr>
              ...
              <td><input id="adjuntos2A" name="adjuntos2" type="radio" value="1" <?php if(isset($row2['Folio_Cliente'])) { if($row3['Adjunta_ComprobanteDom']=='Si'){echo "checked";} } ?> required><label for="adjuntos2A"> Si</label>
            ...
            <tr>
              ...
              <td><input id="adjuntos3A" name="adjuntos3" type="radio" value="1" <?php if(isset($row2['Folio_Cliente'])) { if($row3['DomicilioCoincideId']=='Si'){echo "checked";} } ?> required><label for="adjuntos3A"> Si</label>
	      ...
	      <p align="left">¿ Usted o algún familiar suyo de hasta segundo grado de consanguinidad o afinidad (cónyuge,padre,madre,hijos,hermanos, abuelos, tios, primos, cuñados, suegros, yernos, etc), desempeña o a desempeñado funciones públicas destacadas en el territorio nacional o en el Extranjero (incluyendo puestos de Gobierno Federales, Estatales ,Municipales, funciones gubernamentales o judiciales, en partidos politicos, militares de alta jerarquía, altos ejecutivos de empresas paraestatales, etc.?<br>
                ...
                <input id="PEPS1" name="PEPS" type="radio" value="1" <?php if(isset($row2['Folio_Cliente'])) { if($row3['PEPS']=='Si'){echo "checked";} } ?>><label for="PEPS1"> Si</label>

<input id="PEPS2" name="PEPS" type="radio" value="2" <?php if(isset($row2['Folio_Cliente'])) { if($row3['PEPS']=='No'){echo "checked";} } ?>><label for="PEPS2"> No</label>
	      </p>
